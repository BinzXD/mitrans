export default function Subcribers({id, name, price, duractions, features, isPremium, onSubscribers}) {
    return (
        <>
            {!isPremium &&(<div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content]">
                <div>
                    ...
                    <p className="text-gray-1 text-xs font-light">{duractions} months</p>
                </div>
            ...
            {isPremium && ( <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Unlock 200 awards movies</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <svg
                            width="24"
                        ...
                        <span className="text-sm">180 subtitles available</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <svg
                            width="24"
